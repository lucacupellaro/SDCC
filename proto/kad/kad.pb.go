...
const file_proto_kad_proto_rawDesc = "" +
	...
	"\fUpdateBucket\x12\x14.kad.UpdateBucketReq\x1a\x14.kad.UpdateBucketResB\x0fZ\rproto/kad;kadb\x06proto3"
...
var file_proto_kad_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
...
var file_proto_kad_proto_depIdxs = []int32{
	...
	3,  // 11: kad.Kademlia.Store:input_type -> kad.StoreReq
	5,  // 12: kad.Kademlia.GetNodeList:input_type -> kad.GetNodeListReq
	7,  // 13: kad.Kademlia.LookupNFT:input_type -> kad.LookupNFTReq
	9,  // 14: kad.Kademlia.GetKBucket:input_type -> kad.GetKBucketReq
	11, // 15: kad.Kademlia.Ping:input_type -> kad.PingReq
	13, // 16: kad.Kademlia.UpdateBucket:input_type -> kad.UpdateBucketReq
	4,  // 17: kad.Kademlia.Store:output_type -> kad.StoreRes
	6,  // 18: kad.Kademlia.GetNodeList:output_type -> kad.GetNodeListRes
	8,  // 19: kad.Kademlia.LookupNFT:output_type -> kad.LookupNFTRes
	10, // 20: kad.Kademlia.GetKBucket:output_type -> kad.GetKBucketResp
	12, // 21: kad.Kademlia.Ping:output_type -> kad.PingRes
	14, // 22: kad.Kademlia.UpdateBucket:output_type -> kad.UpdateBucketRes
